...
export default function Home() {
  ...
  const formations = [
    ...
    { titre: "Gestion", icon: "📊", description: "Finance, marketing, RH, Recherce Opératinnelle", color: "from-green-500 to-emerald-500", details: "Licence/Master" },
    ...
    { titre: "Mathématiques", icon: "📐", description: "Statistiques, modélisation, data science", color: "from-orange-500 to-red-500", details: "Licencet" },
            ...
            {formations.map((formation, index) => (
              <div key={index} className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className={`bg-gradient-to-r ${formation.color} p-6 text-white relative overflow-hidden`}>
                  ...
                  <h3 className="text-2xl font-bold relative z-10">{formation.titre}</h3>
                  <p className="text-sm opacity-90 mt-2 relative z-10">{formation.details}</p>
                </div>
                <div className="p-6">
